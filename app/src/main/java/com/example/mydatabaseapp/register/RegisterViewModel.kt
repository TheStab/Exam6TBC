...
class RegisterViewModel(private val repository: RegisterRepository, application: Application) :
    ...
    @Bindable
    val inputPasswordRepeat = MutableLiveData<String>()
    ...
    fun sumbitButton() {
        ...
        if (inputFirstName.value == null || inputLastName.value == null || inputUsername.value == null || inputPassword.value == null || inputPassword.value != inputPasswordRepeat.value) {
